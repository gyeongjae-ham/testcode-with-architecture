...
class UserJpaRepositoryTest {
    ...
    void findByEmailAndStatus로_유저_데이터를_찾아올_수_있다() {
        // Given
        // When
        Optional<UserEntity> result = userJpaRepository.findByEmailAndStatus("kok2020@naver.com", UserStatus.ACTIVE);
    ...
    void findByEmailAndStatus_는_데이터가_없으면_Optional_empty_를_내려준다() {
        // Given
        // When
        Optional<UserEntity> result = userJpaRepository.findByEmailAndStatus("kok2020@naver.com", UserStatus.PENDING);
